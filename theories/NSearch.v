...
From IPC Require Export Disjunct NWeight Lt_Ks NRules.
...
elimtype False.
apply (Nat.nlt_0_r (nweight_Sequent work ds ni ai)); assumption.
...
apply ih_n; try assumption.
apply
 Nat.lt_le_trans with (nweight_Sequent work ds ni (AVL_intro nf_list ai avl_ai)).
